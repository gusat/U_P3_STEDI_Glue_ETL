...
# Script generated for node R-Join Accel /\ Customer
s3customer_trusted_node1688468521236DF = s3customer_trusted_node1688468521236.toDF()
Acceltrusted_node1DF = Acceltrusted_node1.toDF()
RJoinAccelCustomer_node1688204377603 = DynamicFrame.fromDF(
    s3customer_trusted_node1688468521236DF.join(
        Acceltrusted_node1DF,
        (
            s3customer_trusted_node1688468521236DF["email"]
            == Acceltrusted_node1DF["user"]
        ),
        "right",
    ),
    glueContext,
    "RJoinAccelCustomer_node1688204377603",
)

# Script generated for node Consenting only
Consentingonly_node1688480090650 = Filter.apply(
    frame=RJoinAccelCustomer_node1688204377603,
...
# Script generated for node DeDup Customer
DeDupCustomer_node1688480972568 = DynamicFrame.fromDF(
    ...
    glueContext,
    "DeDupCustomer_node1688480972568",
)
...
Customercurated_node3.setCatalogInfo(
    catalogDatabase="stedi", catalogTableName="customer_curated2"
)
Customercurated_node3.setFormat("json")
Customercurated_node3.writeFrame(DeDupCustomer_node1688480972568)
job.commit()
